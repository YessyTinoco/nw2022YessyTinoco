...
<section>
  <form action="index.php?page=mnt_score" method="post">
    ...
    <fieldset>
      ...
      <input {{if readonly}} readonly {{endif readonly}} type="text" id="scoreauthor" name="scoreauthor" placeholder="Nombre del Autor" value="{{scoreauthor}}" />
    ...
    <fieldset>
      ...
      <input {{if readonly}} readonly {{endif readonly}} type="number" id="scoreprice" name="scoreprice" placeholder="Precio" value="{{scoreprice}}" />
      {{if error_scoreprice}}
